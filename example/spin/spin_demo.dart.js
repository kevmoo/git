...
$$.SpinDemo = {"": "StageWrapper;_tx,_mouseLocation,canvas,stage,rootThing,_invalidatedEventId,_frameRequested,_disposed",
  ...
  get$_canvas_mouseMove: function() {
    return new $.BoundClosure0(this, "_canvas_mouseMove$1");
  },
  _canvas_mouseOut$1: function(e) {
    this._mouseLocation = null;
  },
  get$_canvas_mouseOut: function() {
    return new $.BoundClosure0(this, "_canvas_mouseOut$1");
  },
...
$$.CanvasThing = {"": "PanelThing;_children,background,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  setCenter$2: function(thing, value) {
    ...
    this.setTopLeft$2(thing, $.Vector$($.$$sub(value.x, sizeOffset.x), $.$$sub(value.y, sizeOffset.y)));
  }
};
...
$.RetainedDebug__borderThing$bailout = function(state0, ctx, thing, t1, filter, i) {
  switch (state0) {
    case 0:
      if (filter == null || filter.call$1(thing) === true)
        $.RetainedDebug__borderThingCore(ctx, thing);
...
$.RetainedUtil_getCorners = function(thing) {
  return $.toList($.mappedBy($.Box$(0, 0, thing.get$width(), thing.get$height()).getCorners$0(), new $.RetainedUtil_getCorners_anon(thing)));
};
...
$.CONSTANT11 = new Isolate.$isolateProperties.EventStreamProvider("mousemove");
...
$.CONSTANT14 = new Isolate.$isolateProperties.Coordinate(0, 0);
$.CONSTANT10 = new Isolate.$isolateProperties.EventStreamProvider("mouseout");
...
$.Element_mouseMoveEvent = Isolate.$isolateProperties.CONSTANT11;
$.Element_mouseOutEvent = Isolate.$isolateProperties.CONSTANT10;
