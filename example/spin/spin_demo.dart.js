...
$$.SpinDemo = {"":"Object;_lib1_canvas,_stage,_tx,_mouseLocation",
...
$$.Thing = {"":"AttachableObject;cacheEnabled?",
...
$.SpinDemo_SpinDemo = function(canvas) {
  ...
  blue = $.ShapeThing$(100, 100, true, "blue", $.CTC5);
  green = $.ShapeThing$(70, 70, true, "green", $.CTC5);
  red = $.ShapeThing$(40, 40, true, "red", $.CTC6);
  pCanvas.add$1(blue);
  pCanvas.add$1(green);
...
$.CTC12 = new Isolate.$isolateProperties.Coordinate(0, 0);
$.CTC7 = new Isolate.$isolateProperties.DisposedError("Invalid operation on disposed object");
