...
$.SpinDemo_SpinDemo = function(canvas) {
  ...
  blue = $.ShapeThing$(100, 100, "blue", $.CONSTANT6);
  green = $.ShapeThing$(70, 70, "green", $.CONSTANT6);
...
$.RetainedUtil_getCorners = function(thing) {
  return $.toList($.map($.Box$(0, 0, thing.get$width(), thing.get$height()).getCorners$0(), new $.RetainedUtil_getCorners_anon(thing)));
};
...
$.CONSTANT15 = new Isolate.$isolateProperties.Coordinate(0, 0);
...
$.CONSTANT12 = new Isolate.$isolateProperties.EventStreamProvider("mousemove");
$.lazyPort = null;
