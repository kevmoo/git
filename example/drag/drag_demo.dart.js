...
$$.DateTime = {"": "Object;millisecondsSinceEpoch>,isUtc",
  ...
  difference$1: function(other) {
    ...
    if (typeof otherMs !== "number")
      return this.difference$1$bailout(2, null, ms, otherMs);
...
$$.Duration = {"": "Object;inMilliseconds>",
  ...
  get$inSeconds: function() {
    ...
    if (typeof t1 !== "number")
      return this.get$inSeconds$bailout(1, t1);
    return $.CONSTANT4.$tdiv(t1, 1000);
  },
  get$inSeconds$bailout: function(state0, t1) {
    return $.$$tdiv(t1, 1000);
  },
  $eq: function(other) {
    if (other == null)
...
$$._FutureImpl = {"": "Object;_state,_resultOrListeners>",
  ...
  get$_handleError: function() {
    return new $.BoundClosure0(this, "_handleError$2");
  },
  ...
  get$_setValue: function() {
    return new $.BoundClosure1(this, "_setValue$1");
  },
  ...
  get$_setError: function() {
    return new $.BoundClosure1(this, "_setError$1");
  },
...
$$._ForwardingStream = {"": "Stream;",
  ...
  get$_handleData: function() {
    return new $.BoundClosure0(this, "_handleData$2");
  },
  ...
  get$_handleDone: function() {
    return new $.BoundClosure1(this, "_handleDone$1");
  }
};
...
$$._ForwardingStreamSubscription = {"": "Object;_stream,_liblib4$_onData,_onError,_onDone,_subscription",
  ...
  get$_handleData: function() {
    return new $.BoundClosure1(this, "_handleData$1");
  },
  _handleError$1: function(error) {
    this._stream._handleError$2(error, this);
  },
  get$_handleError: function() {
    return new $.BoundClosure1(this, "_handleError$1");
  },
...
$$.DraggerDemo = {"": "Object;_canvas,_stage,_tx,_demoMapper,_mouseLocation,_frameRequested,_thing",
  ...
  get$_onStageInvalidated: function() {
    return new $.BoundClosure1(this, "_onStageInvalidated$1");
  },
  ...
  get$_onDrag: function() {
    return new $.BoundClosure1(this, "_onDrag$1");
  },
  ...
  get$_onFrame: function() {
    return new $.BoundClosure1(this, "_onFrame$1");
  },
  DraggerDemo$_internal$4: function(_canvas, _stage, _tx, _thing) {
    var t1;
    $.add(this._demoMapper.get$outputChanged(), new $.anon2(this));
    t1 = this._stage;
    $.add(t1.get$invalidated(), this.get$_onStageInvalidated());
    $.MouseManager_MouseManager(t1);
    t1 = this._thing;
    $.MouseManager_setDraggable(t1, true);
    $.MouseManager_addDragHandler(t1, this.get$_onDrag());
  }
};
...
$$.Size = {"": "Object;width>,height>",
  ...
  get$isEmpty: function() {
    return new $.BoundClosure2(this, "isEmpty$0");
  },
  get$isValid: function() {
    var t1, t2;
    t1 = this.width;
...
$$.FutureValue = {"": "Object;",
  ...
  get$_futureException: function() {
    return new $.BoundClosure1(this, "_futureException$1");
  },
  ...
  get$_futureCompleted: function() {
    return new $.BoundClosure1(this, "_futureCompleted$1");
  },
  _cleanup$0: function() {
    if (this._pending) {
      this._pending = false;
...
$$.SendPortValue = {"": "FutureValue;",
  ...
  get$__futureCompleted: function() {
    return new $.BoundClosure1(this, "__futureCompleted$1");
  },
...
$$.MouseManager = {"": "Object;_liblib2$_stage,_mouseDownThing,_draggingThing,_dragCoordinate",
  ...
  _mouseUp$1: function(e) {
    var t1, t2;
    t1 = $.Coordinate$(e.get$offsetX(), e.get$offsetY());
    t2 = $.firstMatching($.Mouse_markMouseOver(this._liblib2$_stage, t1), new $.MouseManager__mouseUp_anon(), new $.MouseManager__mouseUp_anon0());
    if (!(t2 == null)) {
  ...
  _mouseDown$1: function(e) {
    ...
    for (t1 = $.iterator($.Mouse_markMouseOver(this._liblib2$_stage, coord)); t1.moveNext$0() === true;) {
      t2 = t1.get$current();
...
$$.ImageThing = {"": "Thing;",
  ...
  get$_onImageLoad: function() {
    return new $.BoundClosure1(this, "_onImageLoad$1");
  }
};
...
$$.SpriteThing = {"": "ImageThing;startCoordinate,nextDelta,count,_frame,_image,_waitingOnLoad,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  _doDraw$1: function(ctx) {
    var t1, msPerFrame, rect;
    t1 = this.count;
    if (typeof t1 !== "number")
      throw $.iae(t1);
    msPerFrame = $.CONSTANT2.$tdiv(1000, t1);
    t1 = $.$$mod($.$$tdiv($.Date_Date$now().get$millisecondsSinceEpoch(), msPerFrame), t1);
    rect = $.Box_Box$fromCoordSize($.$$add(this.startCoordinate, this.nextDelta.$mul(t1)), this.get$size());
...
$$._demoIsolate_anon = {"": "Closure;",
  call$1: function(input) {
    ...
    do
      ;
    while ($.$$lt($.Date_Date$now().difference$1(start).get$inSeconds(), 1) === true);
...
$.CONSTANT12 = new Isolate.$isolateProperties.EventStreamProvider("mouseout");
$.CONSTANT16 = new Isolate.$isolateProperties.Coordinate(0, 0);
$.CONSTANT11 = new Isolate.$isolateProperties.EventStreamProvider("mouseup");
$.CONSTANT14 = new Isolate.$isolateProperties.EventStreamProvider("load");
...
$.BodyElement_blurEvent = Isolate.$isolateProperties.CONSTANT9;
$.BodyElement_loadEvent = Isolate.$isolateProperties.CONSTANT14;
$._cachedBrowserPrefix = null;
$.Element_blurEvent = Isolate.$isolateProperties.CONSTANT9;
$.Element_loadEvent = Isolate.$isolateProperties.CONSTANT14;
$.Element_mouseDownEvent = Isolate.$isolateProperties.CONSTANT10;
$.Element_mouseMoveEvent = Isolate.$isolateProperties.CONSTANT13;
$.Element_mouseOutEvent = Isolate.$isolateProperties.CONSTANT12;
...
// 21 !leaf
(function() {
  var v0_TextPositioningElement = "SVGTextPositioningElement|SVGAltGlyphElement|SVGTRefElement|SVGTSpanElement|SVGTextElement", v1_MediaElement = "HTMLMediaElement|HTMLVideoElement|HTMLAudioElement", v2_SvgElement = [v0_TextPositioningElement, "SVGElement|SVGAElement|SVGAltGlyphDefElement|SVGTextContentElement|SVGTextPathElement|SVGAltGlyphItemElement|SVGAnimationElement|SVGAnimateColorElement|SVGAnimateElement|SVGAnimateMotionElement|SVGAnimateTransformElement|SVGSetElement|SVGClipPathElement|SVGCursorElement|SVGDefsElement|SVGComponentTransferFunctionElement|SVGFEFuncRElement|SVGFEFuncBElement|SVGFEFuncAElement|SVGFEFuncGElement|SVGDescElement|SVGEllipseElement|SVGFEComponentTransferElement|SVGFECompositeElement|SVGFEDiffuseLightingElement|SVGFEBlendElement|SVGFEDistantLightElement|SVGFEDisplacementMapElement|SVGFEConvolveMatrixElement|SVGFEFloodElement|SVGFEGaussianBlurElement|SVGFEDropShadowElement|SVGFEOffsetElement|SVGFEColorMatrixElement|SVGCircleElement|SVGFEMergeElement|SVGFEMergeNodeElement|SVGFESpotLightElement|SVGFontFaceElement|SVGFEImageElement|SVGFESpecularLightingElement|SVGFontFaceSrcElement|SVGForeignObjectElement|SVGFEPointLightElement|SVGGlyphElement|SVGFontFaceNameElement|SVGFETileElement|SVGFETurbulenceElement|SVGFilterElement|SVGGradientElement|SVGLinearGradientElement|SVGRadialGradientElement|SVGHKernElement|SVGFontFaceUriElement|SVGFEMorphologyElement|SVGLineElement|SVGMaskElement|SVGGElement|SVGFontFaceFormatElement|SVGMissingGlyphElement|SVGMarkerElement|SVGImageElement|SVGFontElement|SVGMetadataElement|SVGGlyphRefElement|SVGPathElement|SVGMPathElement|SVGPatternElement|SVGPolygonElement|SVGPolylineElement|SVGScriptElement|SVGStopElement|SVGStyleElement|SVGRectElement|SVGSVGElement|SVGSwitchElement|SVGTitleElement|SVGSymbolElement|SVGUseElement|SVGVKernElement|SVGViewElement"].join("|"), v3_MouseEvent = "MouseEvent|WheelEvent", v4_Element = [v1_MediaElement, v2_SvgElement, "Element|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLSelectElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement|HTMLAppletElement|HTMLBaseFontElement|HTMLDirectoryElement|HTMLFontElement|HTMLFrameElement|HTMLFrameSetElement|HTMLMarqueeElement|HTMLElement|HTMLAnchorElement|HTMLAreaElement|HTMLBRElement|HTMLBaseElement|HTMLBodyElement|HTMLButtonElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDivElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFormElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLImageElement|HTMLInputElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMenuElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPreElement"].join("|"), v5_DocumentFragment = "DocumentFragment|ShadowRoot", v6_CharacterData = "CharacterData|Text|CDATASection|Comment", v7_Document = "Document|SVGDocument|HTMLDocument", v8_Node = [v4_Element, v5_DocumentFragment, v6_CharacterData, v7_Document, "Node|Attr|DocumentType|EntityReference|Notation|ProcessingInstruction"].join("|");
