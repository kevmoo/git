...
$$.MouseManager = {"": "Object;_liblib1$_stage,_mouseDownThing,_draggingThing,_dragCoordinate",
  ...
  _mouseMove$1: function(e) {
    ...
    items = $.Mouse_markMouseOver(this._liblib1$_stage, t1);
  ...
  _mouseUp$1: function(e) {
    var t1, thing;
    t1 = $.Coordinate$(e.get$offsetX(), e.get$offsetY());
    thing = $.firstMatching($.Mouse_markMouseOver(this._liblib1$_stage, t1), new $.MouseManager__mouseUp_anon(), new $.MouseManager__mouseUp_anon0());
    if (!(thing == null)) {
  ...
  _mouseDown$1: function(e) {
    ...
    for (t1 = $.iterator($.Mouse_markMouseOver(this._liblib1$_stage, coord)); t1.moveNext$0() === true;) {
      t2 = t1.get$current();
  ...
  _updateCursor$1: function(cursor) {
    if (cursor == null)
      cursor = "auto";
    this._liblib1$_stage.get$_liblib1$_canvas().get$style().set$cursor(cursor);
  },
  ...
  MouseManager$_internal$1: function(_stage) {
    var t1 = this._liblib1$_stage;
    t1.get$_liblib1$_canvas().get$onMouseMove().listen$1(this.get$_mouseMove());
    t1.get$_liblib1$_canvas().get$onMouseOut().listen$1(this.get$_mouseOut());
    t1.get$_liblib1$_canvas().get$onMouseUp().listen$1(this.get$_mouseUp());
    t1.get$_liblib1$_canvas().get$onMouseDown().listen$1(this.get$_mouseDown());
...
$$.ThingDragStartingEventArgs = {"": "ThingMouseEventArgs;_liblib1$_canceled,thing,sourceEvent",
  get$isCanceled: function() {
    return this._liblib1$_canceled;
  },
  cancel$0: function() {
...
$$.SpriteThing = {"": "ImageThing;startCoordinate,nextDelta,count,_frame,_image,_waitingOnLoad,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  _doDraw$1: function(ctx) {
    ...
    if (typeof t1 !== "number")
      throw $.iae(t1);
    msPerFrame = $.CONSTANT5.$tdiv(1000, t1);
...
$$.Stage = {"": "AttachableObject;_invalidatedEventHandle,_liblib1$_canvas>,rootThing>,_ctx,_propertyValues,_eventHandlers,_disposed",
  ...
  get$ctx: function() {
    this.validateNotDisposed$0();
    if (this._ctx == null)
      this._ctx = this._liblib1$_canvas.get$context2d();
    return this._ctx;
  },
  draw$0: function() {
    var t1, t2;
...
$.CONSTANT15 = new Isolate.$isolateProperties.EventStreamProvider("load");
$.CONSTANT10 = new Isolate.$isolateProperties.EventStreamProvider("blur");
...
$.CONSTANT14 = new Isolate.$isolateProperties.EventStreamProvider("mousemove");
$.CONSTANT11 = new Isolate.$isolateProperties.EventStreamProvider("mousedown");
$.CONSTANT6 = new Isolate.$isolateProperties.DisposedError("Invalid operation on disposed object");
$.CONSTANT12 = new Isolate.$isolateProperties.EventStreamProvider("mouseup");
