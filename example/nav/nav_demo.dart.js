...
$$._NavLayerTxPanel = {"": "PanelThing;_frames,_lastImage,_newChild,_startTx,_goalTx,_myTx,_i,_children,background,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  get$isDone: function() {
    return $.CONSTANT5.$ge(this._i, this._frames);
  },
  update$0: function() {
    var t1, t2, ratio, newTx;
    t1 = this._i;
    t2 = this._frames;
    if ($.CONSTANT5.$lt(t1, t2)) {
      t1 = this._i;
      t2 = $.$$sub(t2, 1);
      if (typeof t2 !== "number")
        throw $.iae(t2);
...
$.NavThing$ = function(width, height) {
  return new $.NavThing($.CONSTANT6, $.CONSTANT7, null, null, null, $.List_List(0), $.EventHandle$(), null, width, height, 1, false, null, null, $.HashMap_HashMap(), $.HashMap_HashMap(), false);
};
...
$._NavLayerTxPanel__NavLayerTxPanel = function(width, height, lastCanvas, newChild, startTx, ghostTx, frameCount, horizontalAlignment, verticalAlignment, childOffset) {
  ...
  goalTx = $.AffineTransform$(1, 0, 0, 1, newChildOffset.get$x(), newChildOffset.get$y());
...
$.CONSTANT18 = new Isolate.$isolateProperties.Object();
$.CONSTANT = new Isolate.$isolateProperties.JSString();
$.CONSTANT0 = new Isolate.$isolateProperties.NullThrownError();
$.CONSTANT7 = new Isolate.$isolateProperties.HorizontalAlignment("center");
$.CONSTANT8 = new Isolate.$isolateProperties.EventArgs();
$.CONSTANT14 = new Isolate.$isolateProperties.HorizontalAlignment("left");
$.CONSTANT12 = new Isolate.$isolateProperties._UndefinedValue();
...
$.CONSTANT6 = new Isolate.$isolateProperties.VerticalAlignment("middle");
$.CONSTANT11 = new Isolate.$isolateProperties.ShapeType("Rect");
$.CONSTANT20 = new Isolate.$isolateProperties.Coordinate(0, 0);
...
$.CONSTANT16 = new Isolate.$isolateProperties.VerticalAlignment("top");
$.CONSTANT13 = new Isolate.$isolateProperties.ShapeType("Ellipse");
$.CONSTANT15 = new Isolate.$isolateProperties.HorizontalAlignment("right");
$.CONSTANT17 = new Isolate.$isolateProperties.VerticalAlignment("bottom");
$.lazyPort = null;
