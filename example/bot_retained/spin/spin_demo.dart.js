...
$$.MappedListIterable = {"": "ListIterable;_source,_f",
  ...
  elementAt$1: function(_, index) {
    return this._f$1($.CONSTANT4.elementAt$1(this._source, index));
  }
};
...
$$.SpinDemo = {"": "StageWrapper;_tx,_mouseLocation,canvas,stage,rootThing,_invalidatedEventSub,_frameRequested,_disposed",
  ...
  SpinDemo$_internal$3: function(canvas, thing, _tx) {
    canvas.get$onMouseMove().listen$1(this.get$_canvas_mouseMove());
    canvas.get$onMouseOut().listen$1(this.get$_canvas_mouseOut());
  }
};
...
$$.AffineTransform = {"": "Object;_scX>,_shY>,_shX>,_scY>,_tX>,_tY>",
  ...
  toString$0: function(_) {
    return $.CONSTANT4.join$1([this.get$scaleX(), this.get$shearY(), this.get$shearX(), this.get$scaleY(), this.get$translateX(), this.get$translateY()], ", ");
  }
};
...
$$.PanelThing = {"": "ParentThing;",
  ...
  insertAt$2: function(thing, index) {
    ...
    t1 = this._children;
    $.requireArgument(!$.CONSTANT4.contains$1(t1, thing), "thing", "Cannot add twice");
    if (index == null)
      index = 0;
    thing.registerParent$1(this);
    $.CONSTANT4.insertRange$3(t1, index, 1, thing);
  ...
  remove$1: function(_, thing) {
    ...
    $.requireArgumentNotNull(thing, "thing");
    t1 = this._children;
    index = $.CONSTANT4.indexOf$1(t1, thing);
    if ($.$$lt$n(index, 0) === true)
      return false;
    else {
      item = $.CONSTANT4.removeAt$1(t1, index);
...
$$.Thing = {"": "AttachableObject;",
  ...
  getTransform$0: function() {
    ...
    $.CONSTANT4.forEach$1(this._transforms, tx.get$concatenate());
    return tx;
  },
  getTransformToRoot$0: function() {
    ...
    $.CONSTANT4.forEach$1(this._transforms, tx0.get$concatenate());
  ...
  addTransform$0: function() {
    this.validateNotDisposed$0();
    var tx = $.AffineTransform$(1, 0, 0, 1, 0, 0);
    $.CONSTANT4.add$1(this._transforms, tx);
    return tx;
  },
  removeTransform$1: function(tx) {
    ...
    t1 = this._transforms;
    index = $.CONSTANT4.indexOf$1(t1, tx);
    if ($.$$lt$n(index, 0) === true)
      return false;
    else {
      $.CONSTANT4.removeAt$1(t1, index);
      return true;
    }
  },
...
$.SpinDemo_SpinDemo = function(canvas) {
  ...
  red = $.ShapeThing$(40, 40, "red", $.CONSTANT2);
...
$.Util_getHashCode = function(source) {
  ...
  for (t1 = $.CONSTANT4.get$iterator(source), hash = 0; t1.moveNext$0(); hash = hash1) {
    t2 = t1.get$current();
...
$.RetainedDebug__borderThing = function(ctx, thing, excludeChildren, filter) {
  ...
  if (excludeChildren !== true && typeof thing === "object" && thing !== null && !!thing.$isParentThing) {
    ...
    while (true) {
      ...
      if (typeof t1 !== "number")
        return $.RetainedDebug__borderThing$bailout(1, ctx, i, thing, filter, t1);
      if (!(i < t1))
        break;
...
$.RetainedDebug__borderThing$bailout = function(state0, ctx, i, thing, filter, t1) {
  switch (state0) {
    case 0:
      if (filter == null || filter.call$1(thing) === true)
        $.RetainedDebug__borderThingCore(ctx, thing);
    case 1:
      if (state0 === 1 || state0 === 0 && excludeChildren !== true && typeof thing === "object" && thing !== null && !!thing.$isParentThing)
        switch (state0) {
          case 0:
            i = 0;
          case 1:
...
$.RetainedDebug__borderThingCore = function(ctx, thing) {
  ...
  ctx.beginPath$0();
  t1 = $.getInterceptor$as(corners);
  ctx.moveTo$2(t1.$index(corners, 3).get$x(), t1.$index(corners, 3).get$y());
...
$.RetainedUtil_getCorners = function(thing) {
  var t1 = $.CONSTANT4.map$1($.Box$(0, 0, thing.get$width(), thing.get$height()).getCorners$0(), new $.RetainedUtil_getCorners_anon(thing));
...
$.CONSTANT11 = new $._UndefinedValue();
$.CONSTANT19 = new $.Coordinate(0, 0);
$.CONSTANT15 = new $.EventStreamProvider("mousemove");
$.CONSTANT12 = new $._LinkedHashTableHeadMarker();
$.CONSTANT14 = new $.EventStreamProvider("mouseout");
$.CONSTANT2 = new $.ShapeType("Ellipse");
$.CONSTANT1 = new $.ShapeType("Rect");
$.CONSTANT16 = new $.Object();
