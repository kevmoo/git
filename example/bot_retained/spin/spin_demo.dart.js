...
$$.MappedListIterable = {"": "ListIterable;_source,_f",
  ...
  elementAt$1: function(index) {
    return this._f$1($.CONSTANT1.elementAt$1(this._source, index));
  }
};
...
$$._FutureImpl = {"": "Object;_state,_resultOrListeners>",
  ...
  _handleValue$1: function(onValue) {
    ...
    $.Timer_Timer($.CONSTANT14, new $._FutureImpl__handleValue_anon(thenFuture, this._resultOrListeners));
    return thenFuture;
  },
  _handleError$2: function(onError, test) {
    ...
    $.Timer_Timer($.CONSTANT14, new $._FutureImpl__handleError_anon(error, errorFuture));
    return errorFuture;
  },
  ...
  _scheduleUnhandledError$0: function() {
    ...
    $.Timer_Timer($.CONSTANT14, new $._FutureImpl__scheduleUnhandledError_anon(this));
  },
...
$.SpinDemo_SpinDemo = function(canvas) {
  ...
  blue = $.ShapeThing$(100, 100, "blue", $.CONSTANT8);
  green = $.ShapeThing$(70, 70, "green", $.CONSTANT8);
  red = $.ShapeThing$(40, 40, "red", $.CONSTANT9);
  pCanvas.add$1(blue);
  pCanvas.add$1(green);
...
$.RetainedDebug__borderThingCore = function(ctx, thing) {
  ...
  ctx.beginPath$0();
  t1 = $.getInterceptor$JSArrayJSString(corners);
...
$.RetainedUtil_getCorners = function(thing) {
  return $.toList($.CONSTANT1.map$1($.Box$(0, 0, thing.get$width(), thing.get$height()).getCorners$0(), new $.RetainedUtil_getCorners_anon(thing)));
};
...
$.CONSTANT14 = new Isolate.$isolateProperties.Duration(0);
