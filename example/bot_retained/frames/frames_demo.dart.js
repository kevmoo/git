...
$$._StreamImpl = {"": "Stream;_state=",
  ...
  _close$0: function() {
    ...
    if (this.get$_mayFireState() !== true) {
      this._addPendingEvent$1($.CONSTANT14);
      return;
    }
    if (this.get$_hasPendingEvent()) {
...
$$._StreamListener = {"": "_InternalLink;_state=",
  ...
  _needsEvent$1: function(currentEventIdBit) {
    ...
    return $.CONSTANT1.$shr(t1 & 4, 2) !== currentEventIdBit;
  },
  _needsEvent$1$bailout: function(state0, currentEventIdBit, t1) {
    switch (state0) {
      ...
      case 2:
        state0 = 0;
        return $.CONSTANT1.$shr(t1, 2) !== currentEventIdBit;
    }
  },
...
$$.TxThing = {"": "ParentThing;_sourceSize,_canvasThing,_shape,_positionShape,_rotateScaleShape,_tx,_rotateScaleCoordinate,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  _dragRotateScale$1: function(e) {
    ...
    this._rotateScaleCoordinate = $.$$add$n(this._rotateScaleCoordinate, e.get$delta());
    pc = this.get$_positionCoordinate();
    pointDeltaVector = $.$$sub$n(this._rotateScaleCoordinate, pc);
    newScale = $.$$div$n($.get$length$as(pointDeltaVector), this._sourceSize.height);
    angle = $.CONSTANT13.getAngle$1(pointDeltaVector);
    t1 = this._tx;
    t1.setToTranslation$2(pc.x, pc.y);
  ...
  TxThing$_internal$5: function(width, height, _sourceSize, _shape, _tx) {
    ...
    $.MouseManager_setDraggable(t3, true);
    $.MouseManager_getDragStream(t3).listen$1(this.get$_dragRotateScale());
    this._updateRotateScale$0();
  }
};
...
$$.AffineTransform = {"": "Object;_scX>,_shY>,_shX>,_scY>,_tX>,_tY>",
  ...
  transformCoordinate$0: function() {
    return this.transformCoordinate$1($.CONSTANT23);
  },
...
$$.CanvasThing = {"": "PanelThing;_children,background,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  setCenter$2: function(thing, value) {
    ...
    this.setTopLeft$2(thing, $.Vector$($.$$sub$n(value.get$x(), sizeOffset.x), $.$$sub$n(value.get$y(), sizeOffset.y)));
  }
};
...
$.TxThing_TxThing = function(width, height) {
  ...
  shape = $.ShapeThing$(box.width, box.height, "blue", $.CONSTANT11);
...
$.TxThing$_internal = function(width, height, _sourceSize, _shape, _tx) {
  var t1 = new $.TxThing(_sourceSize, $.CanvasThing$(width, height), _shape, $.ShapeThing$(20, 20, "gray", $.CONSTANT11), $.ShapeThing$(20, 20, "red", $.CONSTANT11), _tx, null, $.List_List($), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
    ...
    if (typeof thing === "object" && thing !== null && !!thing.$isParentThing) {
      ...
      for (t1 = $length - 1, i = 0; i < $length; ++i) {
        ...
        if (typeof hits !== "object" || hits === null || hits.constructor !== Array || !!hits.fixed$length)
          return $.RetainedUtil__hitTest$bailout(2, thing, point, hits, $length, $.CONSTANT1, i);
        if (hits.length > 0)
          break;
      }
      thing = thing;
...
$.CONSTANT12 = new $._UndefinedValue();
$.CONSTANT17 = new $.EventStreamProvider("mousedown");
$.CONSTANT16 = new $.EventStreamProvider("blur");
$.CONSTANT14 = new $._DelayedDone();
