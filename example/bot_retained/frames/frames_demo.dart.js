...
$$.TxThing = {"": "ParentThing;_sourceSize,_canvasThing,_shape,_positionShape,_rotateScaleShape,_tx,_rotateScaleCoordinate,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  _dragRotateScale$1: function(e) {
    var t1, pc, t2, pointDeltaVector, t3, newScale, angle;
    ...
    pointDeltaVector = t2.$sub(t2, pc);
    t2 = pointDeltaVector.get$length(pointDeltaVector);
    t3 = this._sourceSize.height;
    if (typeof t3 !== "number")
      throw $.iae(t3);
    newScale = t2 / t3;
    angle = $.CONSTANT9.getAngle$1(pointDeltaVector);
    t3 = this._tx;
    t3.setToTranslation$2(pc.x, pc.y);
    t3.rotate$3(t3, angle, 0, 0);
    t3.scale$2(t3, newScale, newScale);
    this._updatePoints$0();
  },
...
$$.AffineTransform = {"": "Object;_scX<,_shY<,_shX<,_scY<,_tX<,_tY<",
  ...
  transformCoordinate$0: function() {
    return this.transformCoordinate$1($.CONSTANT18);
  },
...
$$.MouseManager = {"": "Object;_stage,_mouseDownThing,_draggingThing,_dragCoordinate",
  ...
  _mouseOut$1: function(e) {
    ...
    $.get$MouseManager__mouseOutEvent().fireEvent$2(t1, $.CONSTANT2);
...
$.main = function() {
  $.FrameDemo_FrameDemo($.query$1$x(document, "#content")).requestFrame$0();
};
...
$.FrameDemo$_internal = function(canvas, canvasThing) {
  ...
  t2 = new $.FrameDemo($.TxThing_TxThing(t1.get$width(canvas), t1.get$height(canvas)), canvas, $.Stage$(canvas, canvasThing), canvasThing, null, false, false);
...
$.TxThing_TxThing = function(width, height) {
  ...
  shape = $.ShapeThing$(box.width, box.height, "blue", $.CONSTANT7);
...
$.TxThing$_internal = function(width, height, _sourceSize, _shape, _tx) {
  var t1 = new $.TxThing(_sourceSize, $.CanvasThing$(width, height), _shape, $.ShapeThing$(20, 20, "gray", $.CONSTANT7), $.ShapeThing$(20, 20, "red", $.CONSTANT7), _tx, null, $.List_List($), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
...
$.CONSTANT12 = new $.EventStreamProvider("blur");
$.CONSTANT9 = new $.Vector(0, 10);
