...
$$.ListQueue = {"": "Collection;_table>,_head,_tail,_modificationCount>",
  ...
  _liblib4$_remove$1: function(offset) {
    var mask, t1, t2, i, t3, prevOffset, nextOffset;
    if (offset !== (offset | 0))
      return this._liblib4$_remove$1$bailout(1, offset);
  ...
  _liblib4$_remove$1$bailout: function(state0, offset) {
...
$$.HashMap = {"": "Object;_hashTable",
  ...
  remove$1: function(key) {
    ...
    t1 = this._hashTable;
    offset = t1._liblib4$_remove$1(key);
    if ($.$$lt(offset, 0) === true)
      return;
...
$$._FutureImpl = {"": "Object;_state,_resultOrListeners>",
  ...
  _handleValue$1: function(onValue) {
    ...
    $.Timer_Timer($.CONSTANT16, new $._FutureImpl__handleValue_anon(thenFuture, this._resultOrListeners));
    return thenFuture;
  },
  _handleError$2: function(onError, test) {
    ...
    $.Timer_Timer($.CONSTANT16, new $._FutureImpl__handleError_anon(error, errorFuture));
    return errorFuture;
  },
  ...
  _scheduleUnhandledError$0: function() {
    ...
    $.Timer_Timer($.CONSTANT16, new $._FutureImpl__scheduleUnhandledError_anon(this));
  },
...
$$.MouseManager = {"": "Object;_stage,_mouseDownThing,_draggingThing,_dragCoordinate",
  ...
  _mouseOut$1: function(e) {
    ...
    $.get$MouseManager__mouseOutEvent().fireEvent$2(t1, $.CONSTANT12);
...
$$.ClickDemo_ClickDemo_anon = {"": "Closure;blue_0",
  call$1: function(args) {
    var t1 = this.blue_0;
    t1.set$fillStyle($.$$eq(t1.get$fillStyle(), "blue") === true ? "lightblue" : "blue");
  },
...
$$.ClickDemo_ClickDemo_anon0 = {"": "Closure;",
  call$1: function(args) {
    $.Primitives_printString($.CONSTANT1.toString$0(["up", args]));
    return;
  },
  $is_TimerCallback1: true
};
...
$$.ClickDemo_ClickDemo_anon1 = {"": "Closure;",
  call$1: function(args) {
    $.Primitives_printString($.CONSTANT1.toString$0(["down", args]));
    return;
  },
  $is_TimerCallback1: true
};
...
$.ClickDemo_ClickDemo = function(canvas) {
  ...
  pCanvas.add$1(green);
  pCanvas.setTopLeft$2(green, $.CONSTANT9);
  red = $.ShapeThing$(40, 40, "red", $.CONSTANT10);
  pCanvas.add$1(red);
  pCanvas.setCenter$2(red, $.CONSTANT11);
...
$.CONSTANT11 = new Isolate.$isolateProperties.Coordinate(50, 150);
$.CONSTANT14 = new Isolate.$isolateProperties._UndefinedValue();
$.CONSTANT9 = new Isolate.$isolateProperties.Coordinate(110, 15);
$.CONSTANT16 = new Isolate.$isolateProperties.Duration(0);
...
$.CONSTANT15 = new Isolate.$isolateProperties.EventStreamProvider("blur");
