...
$$._FutureImpl = {"": "Object;_state,_resultOrListeners>",
  ...
  _handleValue$1: function(onValue) {
    ...
    $.Timer_Timer($.CONSTANT11, new $._FutureImpl__handleValue_anon(thenFuture, this._resultOrListeners));
    return thenFuture;
  },
  _handleError$2: function(onError, test) {
    ...
    $.Timer_Timer($.CONSTANT11, new $._FutureImpl__handleError_anon(error, errorFuture));
    return errorFuture;
  },
  ...
  _scheduleUnhandledError$0: function() {
    ...
    $.Timer_Timer($.CONSTANT11, new $._FutureImpl__scheduleUnhandledError_anon(this));
  },
...
$$.DraggerDemo = {"": "Object;_canvas,_stage,_tx,_demoMapper,_mouseLocation,_frameRequested,_thing",
  ...
  get$_onStageInvalidated: function() {
    return new $.Bound__onStageInvalidated_DraggerDemo(this, "_onStageInvalidated$1");
  },
  ...
  DraggerDemo$_internal$4: function(_canvas, _stage, _tx, _thing) {
    var t1;
    $.add(this._demoMapper.get$outputChanged(), new $.anon1(this));
    t1 = this._stage;
...
$$.MouseManager = {"": "Object;_liblib0$_stage,_mouseDownThing,_draggingThing,_dragCoordinate",
  ...
  _mouseMove$1: function(e) {
    ...
    items = $.Mouse_markMouseOver(this._liblib0$_stage, t1);
  ...
  _mouseUp$1: function(e) {
    var t1, thing;
    t1 = $.Coordinate$(e.get$offsetX(), e.get$offsetY());
    thing = $.firstMatching($.Mouse_markMouseOver(this._liblib0$_stage, t1), new $.MouseManager__mouseUp_anon(), new $.MouseManager__mouseUp_anon0());
    if (!(thing == null)) {
  ...
  _mouseDown$1: function(e) {
    ...
    for (t1 = $.iterator($.Mouse_markMouseOver(this._liblib0$_stage, coord)); t1.moveNext$0() === true;) {
      t2 = t1.get$current();
  ...
  _updateCursor$1: function(cursor) {
    if (cursor == null)
      cursor = "auto";
    this._liblib0$_stage.get$_liblib0$_canvas().get$style().set$cursor(cursor);
  },
  ...
  MouseManager$_internal$1: function(_stage) {
    var t1 = this._liblib0$_stage;
    t1.get$_liblib0$_canvas().get$onMouseMove().listen$1(this.get$_mouseMove());
    t1.get$_liblib0$_canvas().get$onMouseOut().listen$1(this.get$_mouseOut());
    t1.get$_liblib0$_canvas().get$onMouseUp().listen$1(this.get$_mouseUp());
    t1.get$_liblib0$_canvas().get$onMouseDown().listen$1(this.get$_mouseDown());
...
$$.ThingDragStartingEventArgs = {"": "ThingMouseEventArgs;_liblib0$_canceled,thing,sourceEvent",
  get$isCanceled: function() {
    return this._liblib0$_canceled;
  },
  cancel$0: function() {
    this._liblib0$_canceled = true;
  }
};
...
$$.SpriteThing = {"": "ImageThing;startCoordinate,nextDelta,count,_frame,_image,_waitingOnLoad,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  _doDraw$1: function(ctx) {
    var t1, msPerFrame, theFrame, sourceCoord, rect;
    t1 = this.count;
    if (typeof t1 !== "number")
      throw $.iae(t1);
    msPerFrame = $.CONSTANT7.$tdiv(1000, t1);
    theFrame = $.$$mod($.$$tdiv($.DateTime$_now().millisecondsSinceEpoch, msPerFrame), t1);
    sourceCoord = $.$$add(this.startCoordinate, this.nextDelta.$mul(theFrame));
    t1 = this.get$size();
    rect = $.Box$(sourceCoord.get$x(), sourceCoord.get$y(), t1.get$width(), t1.get$height());
...
$$.Stage = {"": "AttachableObject;_invalidatedEventHandle,_liblib0$_canvas>,rootThing>,_ctx,_propertyValues,_eventHandlers,_disposed",
  ...
  get$ctx: function() {
    this.validateNotDisposed$0();
    if (this._ctx == null)
      this._ctx = this._liblib0$_canvas.get$context2d();
    return this._ctx;
  },
  draw$0: function() {
    var t1, t2;
...
$$._demoIsolate_anon = {"": "Closure;",
  call$1: function(input) {
    ...
    do
      ;
    while ($.$$lt($.DateTime$_now().difference$1(start).get$inSeconds(), 1) === true);
    t1 = $.getInterceptor$JSArrayJSString(input);
...
$$.Bound__onStageInvalidated_DraggerDemo = {"": "Closure;self,target",
  call$1: function(p0) {
    return this.self[this.target](p0);
  },
  $is_TimerCallback1: true
...
$.SpriteThing$ = function(image, width, height, startCoordinate, nextDelta, count) {
  return new $.SpriteThing(startCoordinate, nextDelta, count, 0, image, false, $.List_List(0), $.EventHandle$(), null, width, height, 1, false, null, null, $.HashMap$(), $.HashMap$(), false);
};
...
$._demoIsolate.$is_TimerCallback0 = true;
...
$.CONSTANT14 = new Isolate.$isolateProperties.EventStreamProvider("mousedown");
$.CONSTANT15 = new Isolate.$isolateProperties.EventStreamProvider("mouseup");
...
$.CONSTANT18 = new Isolate.$isolateProperties.EventStreamProvider("load");
$.CONSTANT13 = new Isolate.$isolateProperties.EventStreamProvider("blur");
...
$.CONSTANT11 = new Isolate.$isolateProperties.Duration(0);
$.lazyPort = null;
