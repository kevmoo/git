...
$$.ListQueue = {"": "Collection;_table>,_head,_tail,_modificationCount>",
  ...
  addAll$1: function(_, elements) {
    ...
    if (typeof elements === "object" && elements !== null && (elements.constructor === Array || elements.$isList())) {
      ...
      for (t1 = $.get$iterator$a(elements); t1.moveNext$0() === true;)
        this._liblib3$_add$1(t1.get$current());
  },
  ...
  _liblib3$_add$1: function(element) {
    ...
    if (typeof t1 !== "number")
      return this._liblib3$_add$1$bailout(1, t1);
    this._modificationCount = t1 + 1;
  },
  _liblib3$_add$1$bailout: function(state0, t1) {
    this._modificationCount = $.$$add$n(t1, 1);
  },
  _liblib3$_remove$1: function(offset) {
    var mask, t1, t2, i, t3, prevOffset, nextOffset;
    if (offset !== (offset | 0))
      return this._liblib3$_remove$1$bailout(1, offset);
  ...
  _liblib3$_remove$1$bailout: function(state0, offset) {
...
$$.HashMap = {"": "Object;_hashTable>",
  ...
  remove$1: function(_, key) {
    ...
    t1 = this._hashTable;
    offset = t1._liblib3$_remove$1(key);
...
$$._StreamImpl = {"": "Stream;_state=",
  ...
  _close$0: function() {
    ...
    if (this.get$_mayFireState() !== true) {
      this._addPendingEvent$1($.CONSTANT12);
      return;
    }
    if (this.get$_hasPendingEvent()) {
...
$$.DraggerDemo = {"": "Object;_canvas,_stage,_tx,_demoMapper,_mouseLocation,_frameRequested,_thing",
  ...
  _onDrag$1: function(args) {
    ...
    t2 = t1.get$translateX();
    t1 = t1.get$translateY();
    this._demoMapper.set$input([t2, t1]);
    this.requestFrame$0();
  },
  ...
  _onFrame$1: function(highResTime) {
    ...
    ctx.fillText$3(inputText, 10, t2.$sub(bottom, 40));
    ctx.fillText$3(outputText, 10, t2.$sub(bottom, 20));
    ctx.restore$0();
...
$$._EventStreamSubscription = {"": "StreamSubscription;_liblib6$_pauseCount,_target,_eventType,_liblib6$_onData,_useCapture",
  cancel$0: function() {
  ...
  get$_paused: function() {
    return this._liblib6$_pauseCount > 0;
  },
  _tryResume$0: function() {
    if (this._liblib6$_onData != null && this.get$_paused() !== true)
      this._target.$$dom_addEventListener$3(this._eventType, this._liblib6$_onData, this._useCapture);
  },
...
$$.AffineTransform = {"": "Object;_scX>,_shY>,_shX>,_scY>,_tX>,_tY>",
  ...
  translate$2: function(dx, dy) {
    ...
    this._tX = $.$$add$n(this._tX, $.$$add$n(t1.$mul(dx, this._scX), t2.$mul(dy, this._shX)));
    this._tY = $.$$add$n(this._tY, $.$$add$n(t1.$mul(dx, this._shY), t2.$mul(dy, this._scY)));
    return this;
  },
...
$$.Coordinate = {"": "Object;x>,y>",
  ...
  $sub: function(_, other) {
    return $.Vector$($.$$sub$n(this.x, other.get$x()), $.$$sub$n(this.y, other.get$y()));
  },
  $add: function(_, other) {
...
$$.Vector = {"": "Coordinate;x,y",
  get$length: function(_) {
    ...
    t1 = $.$$mul$n(t1, t1);
    t2 = this.y;
    return $.sqrt($.$$add$n(t1, $.$$mul$n(t2, t2)));
  },
  $add: function(_, other) {
    return $.Vector$($.$$add$n(this.x, other.get$x()), $.$$add$n(this.y, other.get$y()));
  },
  $mul: function(_, magnitude) {
...
$$.MouseManager = {"": "Object;_liblib2$_stage,_mouseDownThing,_draggingThing,_dragCoordinate",
  ...
  _mouseUp$1: function(e) {
    var t1, thing;
    t1 = $.Coordinate$(e.get$offsetX(), e.get$offsetY());
    thing = $.firstMatching$2$orElse$a($.Mouse_markMouseOver(this._liblib2$_stage, t1), new $.MouseManager__mouseUp_anon(), new $.MouseManager__mouseUp_anon0());
    if (thing != null) {
  ...
  _mouseDown$1: function(e) {
    ...
    for (t1 = $.get$iterator$a($.Mouse_markMouseOver(this._liblib2$_stage, coord)); t1.moveNext$0() === true;) {
      t2 = t1.get$current();
  ...
  MouseManager$_internal$1: function(_stage) {
    var t1 = this._liblib2$_stage;
    t1.get$_liblib2$_canvas().get$onMouseMove().listen$1(this.get$_mouseMove());
    t1.get$_liblib2$_canvas().get$onMouseOut().listen$1(this.get$_mouseOut());
    t1.get$_liblib2$_canvas().get$onMouseUp().listen$1(this.get$_mouseUp());
    t1.get$_liblib2$_canvas().get$onMouseDown().listen$1(this.get$_mouseDown());
...
$$.ImageThing = {"": "Thing;",
  drawOverride$1: function(ctx) {
    ...
    if (t1.get$complete() === true)
      ...
      t1.get$onLoad().listen$1(this.get$_onImageLoad());
    }
  },
...
$$.SpriteThing = {"": "ImageThing;startCoordinate,nextDelta,count,_frame,_image,_waitingOnLoad,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  _doDraw$1: function(ctx) {
    var t1, msPerFrame, theFrame, t2, sourceCoord, rect;
    t1 = this.count;
    if (typeof t1 !== "number")
      throw $.iae(t1);
    msPerFrame = $.CONSTANT10.$tdiv(1000, t1);
    theFrame = $.$$mod$n($.$$tdiv$n($.DateTime$_now().millisecondsSinceEpoch, msPerFrame), t1);
    t1 = this.startCoordinate;
    t2 = this.nextDelta;
    sourceCoord = $.$$add$n(t1, t2.$mul(t2, theFrame));
    t1 = this.get$size();
    rect = $.Box$(sourceCoord.get$x(), sourceCoord.get$y(), t1.width, t1.height);
...
$.Timer_run = function(callback) {
  ...
  if ($.$$eq$o($.get$length$as($.get$Timer__runCallbacks()), 1) === true)
    $.Timer_Timer($.CONSTANT9, new $.Timer_run_anon());
};
...
$.Util_getHashCode = function(source) {
  ...
  for (t1 = $.CONSTANT1.get$iterator(source), hash = 0; t1.moveNext$0(); hash = hash1) {
    t2 = t1.get$current();
    ...
    hash1 = 536870911 & hash0 + ((524287 & hash0) << 10 >>> 0);
    hash1 = (hash1 ^ $.CONSTANT10.$shr(hash1, 6)) >>> 0;
  }
  hash0 = 536870911 & hash + ((67108863 & hash) << 3 >>> 0);
  hash0 = (hash0 ^ $.CONSTANT10.$shr(hash0, 11)) >>> 0;
  return 536870911 & hash0 + ((16383 & hash0) << 15 >>> 0);
};
    ...
    if (typeof thing === "object" && thing !== null && !!thing.$isParentThing) {
      ...
      for (t1 = $length - 1, i = 0; i < $length; ++i) {
        ...
        if (typeof hits !== "object" || hits === null || hits.constructor !== Array || !!hits.fixed$length)
          return $.RetainedUtil__hitTest$bailout(2, thing, point, hits, $length, $.CONSTANT5, i);
        if (hits.length > 0)
          break;
      }
      thing = thing;
...
$.CONSTANT13 = new $._UndefinedValue();
$.CONSTANT3 = new $._NullKey();
$.CONSTANT6 = new $.EventArgs();
$.CONSTANT8 = new $._LinkedHashTableHeadMarker();
$.CONSTANT21 = new $.Coordinate(0, 0);
$.CONSTANT16 = new $.EventStreamProvider("mouseup");
$.CONSTANT17 = new $.EventStreamProvider("mouseout");
$.CONSTANT14 = new $.EventStreamProvider("blur");
$.CONSTANT15 = new $.EventStreamProvider("mousedown");
$.CONSTANT18 = new $.EventStreamProvider("mousemove");
$.CONSTANT19 = new $.EventStreamProvider("load");
$.CONSTANT12 = new $._DelayedDone();
